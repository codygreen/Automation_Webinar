...
resource "null_resource" "jenkins" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "curl https://raw.githubusercontent.com/codygreen/Automation_Webinar/master/code/3%20-%20CICD/setup/jenkins-plugins-list.txt -o jenkins-plugins-list.txt",
      "sudo /usr/local/bin/install-plugins.sh < enkins-plugins-list.txt",
